...
def upgrade() -> None:
    ...
    op.add_column(
        "recipes", sa.Column("portion_size", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "recipes", sa.Column("prep_time_minutes", sa.Integer(), nullable=True)
    )
    op.add_column(
        "recipes", sa.Column("cook_time_minutes", sa.Integer(), nullable=True)
    )
    op.add_column(
        "recipes",
        sa.Column("skill_level_validated", sa.String(length=20), nullable=True),
    )
